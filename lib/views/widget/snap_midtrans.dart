...
class SnapScreen extends StatefulWidget {
  ...
  SnapScreen({this.transactionToken, required this.slug});
    ...
    webViewController!.loadUrl(Uri.dataFromString('''<html>
      <head>
        ...
        <script 
          ...
          data-client-key="SB-Mid-server-mRKYm7832Qa6cVaTu5WbXtSk"
        ></script>
      </head>
              ...
              children: [
                ...
                Center(
                  child: ElevatedButton(
                      ...
                      child: Text('Close'),
                      onPressed: () => Get.until(
                          (route) => Get.currentRoute == '/campaign/detail')
  ...
  List<String> getResult() {
    ...
    switch (statusCode) {
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_200:
        title = 'Donasi diterima, terima kasih atas donasi nya!';
        break;

      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_201:
        title = 'Donasi diterima, terima kasih telah memberikan donasi!';

        if (paymentType == MIDTRANS_PAYMENT_TYPE.bank_transfer) {
          desc = 'Pembayaran donasi anda akan expired dalam waktu 24 jam.';
        }
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_202:
        title = 'Fraud detection!';
        desc = 'Pembayaran donasi anda telah expired.';
        break;
